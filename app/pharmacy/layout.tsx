...
import { Activity, FileText, LogOut, Package, Pill, Menu, X, LayoutDashboard } from 'lucide-react';
                  ...
                  return (
                    <a
                      ...
                      className={`flex items-center px-4 py-3 text-base font-medium rounded-lg ${
                        ...
                        (item.href === '/pharmacy/prescriptions' && router.pathname === '/pharmacy/prescriptions') ||
                        (item.href === '/pharmacy/inventory' && router.pathname === '/pharmacy/inventory')
